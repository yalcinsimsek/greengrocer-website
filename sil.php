...
$sql = "DELETE FROM urun WHERE urid = $urun_id";
...
if ($conn->query($sql) === TRUE) {
    ...
    echo '<h2 style="font-size: 24px; font-weight: bold; margin-bottom: 20px;">Ürün Silme</h2>';
    echo '<p style="color: red; font-size: 18px; font-weight: bold;">Ürün başarıyla silindi.</p>';
