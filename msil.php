...
if ($conn->query($sql) === TRUE) {
    ...
    echo '<h2 style="font-size: 24px; font-weight: bold; margin-bottom: 20px;">Mesaj Silme</h2>';
    echo '<p style="color: red; font-size: 18px; font-weight: bold;">Mesaj başarıyla silindi.</p>';
    echo '<a href="gkutusu.php" style="font-size: 18px; font-weight: bold; padding: 8px; background-color: #F28123; color: white; border: none; border-radius: 5px; text-decoration: none; margin-top: 10px;">Geri Dön</a>';
    echo '</div>';
    echo '</div>';
} else {
