...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $resim_yol = "assets/img/products/" . $resim;

    
    $sql = "INSERT INTO urun (urid, adı, stok, acıklama, kategori, fiyat, resim) VALUES ('$urid', '$adı', '$stok', '$acıklama', '$kategori', '$fiyat', '$resim')";

    if ($conn->query($sql) === TRUE) {
       
        move_uploaded_file($resim_tmp, $resim_yol);
        $success_message = "Ürün başarıyla kaydedildi.";
    } else {
        echo "Hata: " . $sql . "<br>" . $conn->error;
    }
}

$sql = "SELECT MAX(urid) AS max_urid FROM urun";
...
<div style="display: flex; justify-content: center; align-items: center; height: 112vh;">
    <div style="background-color: #f1f1f1; padding: 20px; border-radius: 10px; text-align: center;">
        <h2 style="font-size: 24px; font-weight: bold; margin-bottom: 20px;">Ürün Ekleme</h2>
        ...
        <form method="POST" action="<?php echo $_SERVER["PHP_SELF"]; ?>" enctype="multipart/form-data">
            ...
            <input type="text" name="urid" value="<?php echo $urid; ?>" style="font-size: 16px; font-weight: bold; padding: 5px; width: 300px; margin-bottom: 10px;" readonly><br>
            <span style="font-size: 18px; font-weight: bold;">Ürün Adı:</span><br>
            <input type="text" name="adı" value="<?php echo $adı; ?>" style="font-size: 16px; font-weight: bold; padding: 5px; width: 300px; margin-bottom: 10px;"><br>
            <span style="font-size: 18px; font-weight: bold;">Stok Durumu:</span><br>
            <input type="text" name="stok" value="<?php echo $stok; ?>" style="font-size: 16px; font-weight: bold; padding: 5px; width: 300px; margin-bottom: 10px;"><br>
            <span style="font-size: 18px; font-weight: bold;">Açıklama:</span><br>
            <textarea name="acıklama" style="font-size: 16px; font-weight: bold; padding: 5px; width: 300px; height: 100px; margin-bottom: 10px;"><?php echo $acıklama; ?></textarea><br>
...
<select name="kategori" style="font-size: 16px; font-weight: bold; padding: 5px; width: 300px; margin-bottom: 10px;">
    <option value="Meyve" <?php if($kategori == "Meyve") echo "selected"; ?>>Meyve</option>
    <option value="Sebze" <?php if($kategori == "Sebze") echo "selected"; ?>>Sebze</option>
    <option value="Şarküteri" <?php if($kategori == "Şarküteri") echo "selected"; ?>>Şarküteri</option>
    <option value="Diğer" <?php if($kategori == "Diğer") echo "selected"; ?>>Diğer</option>
</select><br>
            <span style="font-size: 18px; font-weight: bold;">Fiyat:</span><br>
            <input type="text" name="fiyat" value="<?php echo $fiyat; ?>" style="font-size: 16px; font-weight: bold; padding: 5px; width: 300px; margin-bottom: 10px;"><br>
