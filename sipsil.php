...
<?php
    ...
    echo '<h2 style="font-size: 24px; font-weight: bold; margin-bottom: 20px;">Sipariş</h2>';
    echo '<p style="color: green; font-size: 18px; font-weight: bold;">Sipariş başarıyla değiştirildi.</p>';
    echo '<a href="sipkon.php" style="font-size: 18px; font-weight: bold; padding: 8px; background-color: #F28123; color: white; border: none; border-radius: 5px; text-decoration: none; margin-top: 10px;">Geri Dön</a>';
    echo '</div>';
    echo '</div>';
